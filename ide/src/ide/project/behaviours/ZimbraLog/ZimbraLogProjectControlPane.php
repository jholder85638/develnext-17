...
class ZimbraLogProjectControlPane extends AbstractProjectControlPane
{
    /**
...
//        return "backup.project.archive::Архив проекта";
    ...
    protected function makeUi()
    {
        ...
        $cellFactory = function (UXListCell $cell, ZimbraLog $backup = null) {
            $cell->text = null;
            $cell->graphic = null;
    ...
    private function createContextCommands(UXListView $listView)
    {
        ...
        return [
            new ZimbraLogRestoreMenuCommand($this->behaviour, $backupGetter),
            new ZimbraLogDeleteMenuCommand($this->behaviour, $backupGetter),
        ];
    }
    ...
    private function createAutoActionPane(UXListView $listView)
    {
        ...
        $box = UiUtils::makeCommandPane([
            ...
            new ZimbraLogDeleteMenuCommand($this->behaviour, $backupGetter),
            '-',
            new ZimbraLogCleanAutoCommand($this->behaviour),
            '-',
            new ZimbraLogSettingsMenuCommand($this->behaviour)
        ]);
        $box->minHeight = 32;
        $box->spacing = 7;
    ...
    private function createMasterActionPane(UXListView $listView)
    {
        ...
        $box = UiUtils::makeCommandPane([
            ...
            new ZimbraLogDeleteMenuCommand($this->behaviour, $backupGetter),
            '-',
            new ZimbraLogCleanMasterCommand($this->behaviour)
        ]);
        $box->minHeight = 32;
        $box->spacing = 5;
